...
fun CategorySelectionCard(
    ...
    val shadow = if (isSelected) BrutalistDimens.ShadowSmall else BrutalistDimens.ShadowMedium
    ...
    Box(
        modifier = modifier
            ...
            .brutalistCard(
                ...
                borderWidth = if (isSelected) BrutalistDimens.BorderThick else BrutalistDimens.BorderThin
            )
            .clickable { onClick() }
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(BrutalistDimens.SpacingSmall))

            Text(
                text = stringResource(category.nameResId).uppercase(),
