...
import com.example.nsddemo.presentation.screen.voting_results.components.VoteResultRow
            ...
            CompositionLocalProvider(LocalIndication provides NoFeedbackIndication()) {
                VotingResultsContent(
                    ...
                    voteCounts = listOf(
                        ...
                        Player(id = "p3", name = "You", color = NewPlayerColors.Blue.hexCode) to 0
                    ),
                    isHost = true,
                    onShowScores = {}
                )
        ...
        Surface {
            CompositionLocalProvider(LocalIndication provides NoFeedbackIndication()) {
                VotingResultsContent(
                    ...
                    voteCounts = listOf(
                        Player(id = "p3", name = "You", color = NewPlayerColors.Blue.hexCode) to 4,
                        Player(
                            id = "p1",
                            name = "RoboPlayer",
                            color = NewPlayerColors.Red.hexCode
