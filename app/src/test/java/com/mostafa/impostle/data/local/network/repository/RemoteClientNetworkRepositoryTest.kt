package com.mostafa.impostle.data.local.network.repository

import android.net.nsd.NsdServiceInfo
import android.util.Log
import app.cash.turbine.test
import com.mostafa.impostle.data.local.network.nsd.discovery.NetworkDiscovery
import com.mostafa.impostle.data.local.network.nsd.discovery.NsdDiscoveryEvent
import com.mostafa.impostle.data.local.network.nsd.discovery.NsdDiscoveryState
import com.mostafa.impostle.data.local.network.nsd.resolution.NetworkResolution
import com.mostafa.impostle.data.local.network.nsd.resolution.NsdResolutionState
